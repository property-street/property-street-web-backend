...
REFRESH_SECRET_KEY = os.getenv('REFRESH_SECRET_KEY') or JWT_SECRET_KEY
REFRESH_TOKEN_EXPIRY_MINUTES = int(os.getenv('REFRESH_TOKEN_EXPIRY_MINUTES', '43200'))
...
UNLIMITED_BETA_AGENTS_EMAILS=[*(os.getenv("UNLIMITED_BETA_AGENTS_EMAILS").split(',')),ADMIN_EMAIL]
TEST_UNLIMITED_BETA_AGENTS_EMAIL=os.getenv("TEST_UNLIMITED_BETA_AGENTS_EMAIL")
